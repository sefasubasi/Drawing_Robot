...
namespace Drawing_Robot
{
    public partial class Form1 : Form
    {
        ...
        {
            string[] lines = File.ReadAllLines(@"C:\Users\Sefa\Desktop\10\Drawing_Robot\Drawing_Robot\Drawing_Robot\dizi.txt", Encoding.UTF8);//txt ten alýnan veriler bir diziye line line eklenir

            foreach (string line in lines)//dizideki her eleman listbox a item olarak eklenir.
            {
